...
docker run --net=my-network-bridge --name=mysql-server --rm -p 3306:3306 -e MYSQL_ROOT_PASSWORD=toto4242  -v c:/docker_project/mysql:/var/lib/mysql -d mysql:latest
